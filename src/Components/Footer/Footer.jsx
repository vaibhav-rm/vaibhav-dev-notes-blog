...
function Footer() {
    return (
        <section className="relative overflow-hidden py-10 bg-white dark:bg-gray-800 transition-colors duration-200 rounded shadow-[0_3px_10px_rgb(0,0,0,0.2)]">            <div className="relative z-10 mx-auto max-w-7xl px-4">
